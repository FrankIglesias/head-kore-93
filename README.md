...
**scroll-driven storytelling** — combining native CSS scroll timelines with
GSAP `ScrollTrigger` for the heavier cinematic sequences.
...
- **Showcase** — a pinned, scrubbed GSAP timeline that tilts the skis flat, splits the pair apart, then flips them from topsheet to base.
...
- **Traverse** — a horizontal-scroll panel track of the geometry and spec numbers.
...
- [GSAP](https://gsap.com/) with `ScrollTrigger` (pinned, scrubbed timelines + horizontal scroll)
- Native CSS scroll-driven animations / scroll timelines
